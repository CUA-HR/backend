...
import { AllTeachers, CreateTeacher, DeleteTeacher,ExportTeachersToXlsx, ImportTeachersXlsx, Teacher, UpdateTeacher, UpgradeTeacher } from "../teacher/controller/teacher.controller";
